...
#ifndef __UB_TEGRA_SDMMC_H__
#define __UB_TEGRA_SDMMC_H__
...
typedef struct mmc_config MMC_CONFIG, *PMMC_CONFIG;
typedef struct tegra_mmc_priv TEGRA_MMC_PRIV, *PTEGRA_MMC_PRIV;
