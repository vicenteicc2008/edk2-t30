 ...
 */
unsigned long clock_start_pll(enum clock_id id, UINT32 divm, UINT32 divn,
		UINT32 divp, UINT32 cpcon, UINT32 lfcon);
 ...
 */
int clock_ll_read_pll(enum clock_id clkid, UINT32 *divm, UINT32 *divn,
		UINT32 *divp, UINT32 *cpcon, UINT32 *lfcon);
...
BOOLEAN clock_early_init_done(void);

/* Returns a pointer to the clock source register for a peripheral */
UINT32 *get_periph_source_reg(enum periph_id periph_id);
 ...
 */
int clock_set_rate(enum clock_id clkid, UINT32 n, UINT32 m, UINT32 p, UINT32 cpcon);
